			...
			<div className='setting_items w_100 border_box flex flex_column'>
				<div className='setting_item w_100 border_box flex justify_between align_center'>
					<div className='flex flex_column'>
						<span className='name'>{locale_messages.layout.setting.update_menu.title}</span>
						<span className='desc'>{locale_messages.layout.setting.update_menu.desc}</span>
					</div>
					<Button
						...
						onClick={() => getUserMenu()}
					>
						<span>{locale_messages.layout.setting.update_menu.btn_text}</span>
					</Button>
				</div>
				<div className='setting_item w_100 border_box flex justify_between align_center'>
					<span className='name'>{locale_messages.layout.setting.language.title}</span>
					<Switch
						checkedChildren='EN'
				...
				<div className='setting_item w_100 border_box flex justify_between align_center'>
					<span className='name'>{locale_messages.layout.setting.theme.title}</span>
					<Switch
